...
myBrowser :: String
myBrowser = "firedragon "  -- Sets firedragon as browser

myEmacs :: String
myEmacs = "emacsclient -c -a 'emacs' "  -- Makes emacs keybindings easier to type

myEditor :: String
myEditor = "alacritty -e nvim"  -- Sets emacs as editor
...
myStartupHook = do
  ...
  spawnOnce "picom --config ~/.config/picom/picom-blur.conf --experimental-backends"
  spawnOnce "sxhkd -c $HOME/.config/sxhkd/sxhkdrc"
...
myWorkspaces = [" www ", " dev ", " project ", " chat ", " dox ", " sys ", " mus ", " rand "]
